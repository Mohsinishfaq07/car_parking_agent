...
import 'package:sb_myreports/features/dashboard/presentation/pages/history_page.dart';
...
import '../../features/dashboard/presentation/pages/my_history_page.dart';
    ...
    if (shouldAddPage) {
      switch (pageConfig.uiPage) {
        ...
        case Pages.allHistoryPage:
          _addPageData(AllHistoryPageContent(), pageConfig);
          break;
          case Pages.myHistoryPage:
          _addPageData(MyHistoryPageContent(), pageConfig);
          break;
      }
    }
  }
